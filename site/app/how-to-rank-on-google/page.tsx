...
export const metadata: Metadata = {
  ...
  description:
    "Step-by-step guide to ranking on Google. Covers keyword research, on-page optimization, content strategy, and link building.",
...
const steps = [
  {
    ...
    content: [
      ...
      <>You do not need expensive tools to start. Free resources like <a href="https://ads.google.com/home/tools/keyword-planner/" target="_blank" rel="noopener noreferrer" className="text-accent-dark hover:text-accent font-medium underline underline-offset-2">Google Keyword Planner</a> can show you exactly what people search for and how competitive each term is. Type your service into Google and look at the &quot;People also ask&quot; section and the related searches at the bottom of the page. Those are real queries from real people.</>,
    ],
    schemaText: [
      "Before you optimize anything, you need to know what your customers are actually searching for. This is not about guessing. It is about finding the exact words and phrases people type into Google when they need what you sell.",
      "Start simple: think about the questions your customers ask you most often. \"How much does [your service] cost?\" \"Best [your service] near [your city].\" \"How to fix [problem you solve].\" Those are your starting keywords.",
      "You do not need expensive tools to start. Free resources like Google Keyword Planner can show you exactly what people search for and how competitive each term is. Type your service into Google and look at the \"People also ask\" section and the related searches at the bottom of the page. Those are real queries from real people.",
    ],
  },
  {
    number: "02",
    ...
    content: [
      ...
      <>Your site needs to load in under 3 seconds (test it at <a href="https://pagespeed.web.dev/" target="_blank" rel="noopener noreferrer" className="text-accent-dark hover:text-accent font-medium underline underline-offset-2">Google PageSpeed Insights</a>). It must work perfectly on mobile devices. Every page needs to be accessible via a clean URL. Your site needs HTTPS (SSL certificate). And you should submit a sitemap to Google Search Console so Google can find all your pages.</>,
  ...
  },
  {
    ...
    content: [
      ...
      <>Never buy links or use shady link-building services. Google penalizes sites that try to manipulate their rankings through artificial link building. If you want to learn proven, ethical strategies, <a href="https://moz.com/beginners-guide-to-link-building" target="_blank" rel="noopener noreferrer" className="text-accent-dark hover:text-accent font-medium underline underline-offset-2">Moz&apos;s beginner guide to link building</a> is an excellent starting point. Quality over quantity, always.</>,
    ],
    schemaText: [
      "When other reputable websites link to yours, it tells Google your site is trustworthy and authoritative. This is one of the most powerful ranking factors and also one of the hardest to influence.",
      "Start with easy wins: get listed in your local Chamber of Commerce, industry associations, and supplier directories. If you sponsor local events or charities, ask for a link on their website. Create genuinely useful resources (guides, tools, data) that other sites want to reference.",
      "Never buy links or use shady link-building services. Google penalizes sites that try to manipulate their rankings through artificial link building. If you want to learn proven, ethical strategies, Moz's beginner guide to link building is an excellent starting point. Quality over quantity, always.",
    ],
  },
  {
    number: "07",
    ...
    content: [
      <>SEO is not a set-it-and-forget-it activity. You need to track your progress and adjust your strategy based on what is working. Set up Google Analytics and <a href="https://search.google.com/search-console/about" target="_blank" rel="noopener noreferrer" className="text-accent-dark hover:text-accent font-medium underline underline-offset-2">Google Search Console</a> (both free) to monitor your organic traffic, keyword rankings, and click-through rates.</>,
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            step: steps.map((s, i) => ({
              ...
              position: i + 1,
              name: s.title,
              text: (s.schemaText ?? s.content).join(" "),
            })),
          }),
        }}
      />
